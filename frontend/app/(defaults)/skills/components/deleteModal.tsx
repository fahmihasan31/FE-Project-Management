...
import { deleteSkills } from '@/store/slices/skills';
...
const DeleteModal = ({ isOpen, onClose, skillId }: DeleteModalProps) => {
    ...
    const handleDelete = async () => {
        ...
        try {
            await dispatch(deleteSkills(skillId)).unwrap();
            ...
            <div className="relative max-h-full w-full max-w-lg p-6">
                <div className="relative rounded-lg bg-white p-8 shadow dark:bg-gray-800 sm:p-8">
                    <div className="text-center">
                        ...
                        <h3 className="mb-6 text-xl font-normal text-gray-900 dark:text-white">Are you sure you want to delete this skills?</h3>
