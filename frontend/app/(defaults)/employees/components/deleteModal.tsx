...
import { deleteEmployees } from '@/store/slices/employees';
...
const DeleteModal = ({ isOpen, onClose, employeeId }: DeleteModalProps) => {
            ...
            <div className="relative max-h-full w-full max-w-lg p-6">
                <div className="relative rounded-lg bg-white p-8 shadow dark:bg-gray-800 sm:p-8">
                    <div className="text-center">
                        ...
                        <h3 className="mb-6 text-xl font-normal text-gray-900 dark:text-white">Are you sure you want to delete this employee?</h3>
